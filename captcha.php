...
class SimpleCaptcha {
  ...
  /** Captcha name to store specific captcha */
  ...
  /**
   * SimpleCaptcha constructor.
   */
  public function __construct( $cname )
  {
    $this->captcha_name = $cname;
  }
  ...
  public function CreateImage()
  {
    ...
    if( !empty( $_SESSION[$this->session_var][$this->captcha_name] ) ) {
      unset($_SESSION[$this->session_var][$this->captcha_name]);
    }

    $_SESSION[$this->session_var][$this->captcha_name] = $text;
  ...
  public function check( $value ) {
    if( empty($_SESSION[$this->session_var][$this->captcha_name]) || strtolower(trim($value)) != $_SESSION[$this->session_var][$this->captcha_name]) {
      return 1;
    }
    unset( $_SESSION[$this->session_var][$this->captcha_name] );
    return 0;
